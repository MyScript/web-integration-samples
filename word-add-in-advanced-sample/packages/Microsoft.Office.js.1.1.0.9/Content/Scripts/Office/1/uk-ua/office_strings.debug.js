...
Strings.OfficeOM.L_NetworkProblem = "Проблема мережі";
...
Strings.OfficeOM.L_OverwriteWorksheetData = "Не вдалося виконати операцію встановлення, тому що наданий об’єкт даних перезапише або зсуне дані.";
...
Strings.OfficeOM.L_InvalidReadForBlankRow = "Указаний рядок порожній.";
...
Strings.OfficeOM.L_TooManyIncompleteRequests = "Дочекайтеся завершення попереднього виклику.";
...
Strings.OfficeOM.L_SpecifiedIdNotExist = "Указаний ідентифікатор не існує.";
...
Strings.OfficeOM.L_RequestTokenUnavailable = "Цей API настроєно, щоб знизити частоту викликів.";
...
Strings.OfficeOM.L_NavOutOfBound = "Не вдалося виконати операцію, оскільки індекс поза межами діапазону.";
...
Strings.OfficeOM.L_SliceSizeNotSupported = "Указаний розмір роздільника не підтримується.";
...
Strings.OfficeOM.L_RequestTimeout = "Виклик тривав занадто довго, тому не вдалося його виконати.";
...
Strings.OfficeOM.L_MemoryLimit = "Перевищено обмеження пам’яті";
Strings.OfficeOM.L_CellDataAmountBeyondLimits = "Примітка: рекомендована кількість клітинок у таблиці – менше 20 000.";
Strings.OfficeOM.L_InvalidTableOptionValue = "Принаймні один параметр tableOptions має неприпустиме значення. Перевірте значення і спробуйте ще раз.";
Strings.OfficeOM.L_PermissionDenied = "Відмовлено в дозволі";
Strings.OfficeOM.L_InvalidDataObject = "Неприпустимий об’єкт даних";
Strings.OfficeOM.L_UserNotSignedIn = "Ніхто з користувачів не ввійшов у службу Office.";
...
Strings.OfficeOM.L_NetworkProblemRetrieveFile = "Не вдалось отримати файл через помилку мережі.";
