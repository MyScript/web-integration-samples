...
_u.ExtensibilityStrings.l_DeleteAttachmentDoesNotExist_Text = "Вложение с таким индексом не найдено, поэтому его невозможно удалить.";
...
_u.ExtensibilityStrings.l_AttachmentErrorName_Text = "Ошибка вложения";
_u.ExtensibilityStrings.l_InvalidEventDates_Text = "Дата окончания предшествует дате начала.";
_u.ExtensibilityStrings.l_DisplayNameTooLong_Text = "Одно или несколько указанных отображаемых имен имеют слишком большую длину.";
...
_u.ExtensibilityStrings.l_DataWriteErrorName_Text = "Ошибка записи данных";
...
_u.ExtensibilityStrings.l_AttachmentDeletedBeforeUploadCompletes_Text = "Пользователь удалил вложение до того, как оно было добавлено.";
...
_u.ExtensibilityStrings.l_CannotAddAttachmentBeforeUpgrade_Text = "Невозможно добавить вложения, пока идет получение полного ответа или переадресованного сообщения с сервера.";
...
_u.ExtensibilityStrings.l_CursorPositionChanged_Text = "Пользователь изменил положение курсора во время добавления данных."
