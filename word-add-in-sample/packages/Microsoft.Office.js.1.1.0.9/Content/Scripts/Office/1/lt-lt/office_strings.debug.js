...
Strings.OfficeOM.L_EventHandlerNotExist = "Nerasta nurodyta šio susiejimo įvykio apdorojimo programa.";
...
Strings.OfficeOM.L_NetworkProblem = "Tinklo problema";
...
Strings.OfficeOM.L_CloseFileBeforeRetrieve = "Kreiptis į „closeAsync“ dabartiniame faile prieš gaunant kitą.";
...
Strings.OfficeOM.L_InvalidCellsValue = "Vieno arba kelių langelių parametrų neleistinos reikšmės. Dar kartą patikrinkite reikšmes ir bandykite vėl.";
Strings.OfficeOM.L_DataNotMatchBindingType = "Nurodytas duomenų objektas nesuderinamas su susiejimo tipu.";
Strings.OfficeOM.L_InvalidFormatValue = "Vieno arba kelių formato parametrų neleistinos reikšmės. Dar kartą patikrinkite reikšmes ir bandykite vėl.";
...
Strings.OfficeOM.L_FormattingReminder = "Formatavimo priminimas";
...
Strings.OfficeOM.L_CellFormatAmountBeyondLimits = "Pastaba: formatavimo API iškvietimo nustatomų formatavimo rinkinių turi būti mažiau 100.";
Strings.OfficeOM.L_TooManyIncompleteRequests = "Palaukite, bus baigtai ankstesni skambučiai.";
...
Strings.OfficeOM.L_APICallFailed = "API iškvietimas nepavyko";
...
Strings.OfficeOM.L_NonUniformPartialGetNotSupported = "Koordinuotų parametrų negalima naudoti su privertimo tipu Lentelė, kai lentelėje yra sulietų langelių.";
...
Strings.OfficeOM.L_APINotSupported = "API nepalaikoma";
Strings.OfficeOM.L_SliceSizeNotSupported = "Nurodytas segmento dydis nepalaikomas.";
...
Strings.OfficeOM.L_MemoryLimit = "Viršytas atminties limitas";
Strings.OfficeOM.L_CellDataAmountBeyondLimits = "Pastaba: lentelės langelių skaičius neturi siekti 20 000.";
...
Strings.OfficeOM.L_NetworkProblemRetrieveFile = "Dėl tinklo problemos nepavyko gauti failo.";
