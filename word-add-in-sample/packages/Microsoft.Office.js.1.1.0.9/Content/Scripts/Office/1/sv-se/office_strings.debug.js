...
Strings.OfficeOM.L_EventHandlerNotExist = "Den angivna händelsehanteraren kan inte användas för den här bindningen.";
...
Strings.OfficeOM.L_DataWriteReminder = "Påminnelse om dataskrivning";
...
Strings.OfficeOM.L_NetworkProblem = "Nätverksproblem";
...
Strings.OfficeOM.L_InvalidReadForBlankRow = "Den angivna raden är tom.";
...
Strings.OfficeOM.L_CloseFileBeforeRetrieve = "Anropa closeAsync på den aktuella filen innan du hämtar en annan.";
...
Strings.OfficeOM.L_InvalidCellsValue = "En eller flera av cellens parametrar har värden som inte är tillåtna. Kontrollera värdena och försök igen.";
Strings.OfficeOM.L_DataNotMatchBindingType = "Det angivna dataobjektet är inte kompatibelt med bindningstypen.";
Strings.OfficeOM.L_InvalidFormatValue = "En eller flera av formatparametrarna har värden som inte är tillåtna. Kontrollera värdena och försök igen.";
...
Strings.OfficeOM.L_FormattingReminder = "Formateringspåminnelse";
...
Strings.OfficeOM.L_CellFormatAmountBeyondLimits = "Obs! De formateringsuppsättningar som anges av ett anrop av formaterings-API:t bör vara under 100.";
Strings.OfficeOM.L_TooManyIncompleteRequests = "Vänta tills det föregående samtalet har avslutats.";
...
Strings.OfficeOM.L_APICallFailed = "API-anropet misslyckades";
...
Strings.OfficeOM.L_RequestTokenUnavailable = "Den här API:n har begränsats för att sänka samtalsfrekvensen.";
...
Strings.OfficeOM.L_APINotSupported = "API:n stöds inte";
...
Strings.OfficeOM.L_RequestTimeout = "Det tog för lång tid att köra samtalet.";
...
Strings.OfficeOM.L_MemoryLimit = "Minnesbegränsningen överskreds";
Strings.OfficeOM.L_CellDataAmountBeyondLimits = "Obs! Det bör inte finnas fler än 20 000 celler i en tabell.";
Strings.OfficeOM.L_InvalidTableOptionValue = "Ett eller flera av tabellAlternativens parameterar har värden som inte är tillåtna. Kontrollera värdena och försök igen.";
Strings.OfficeOM.L_PermissionDenied = "Åtkomst nekad";
Strings.OfficeOM.L_InvalidDataObject = "Ogiltigt dataobjekt";
Strings.OfficeOM.L_UserNotSignedIn = "Ingen användare är inloggad i Office.";
...
Strings.OfficeOM.L_NetworkProblemRetrieveFile = "Ett nätverksproblem förhindrade hämtningen av filen.";
