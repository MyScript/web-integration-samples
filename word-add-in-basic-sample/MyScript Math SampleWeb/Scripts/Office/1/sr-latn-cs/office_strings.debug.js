...
Strings.OfficeOM.L_EventHandlerNotExist = "_Ťhě şpëćîfîëđ ëvěňť hăńđľęř wąś ňöť fôµňď föř ţhíš bíńđîńg.džšćđČdžš_";
...
Strings.OfficeOM.L_DataWriteReminder = "_Đäţä Wřîťé Řěmîńďěŕdžš_";
...
Strings.OfficeOM.L_NetworkProblem = "_Ňěţwôŕk Pŕőbłémdž_";
...
Strings.OfficeOM.L_InvalidReadForBlankRow = "_Ţhé şpęčífîěď ŕôw îš bľáńk.džšć_";
...
Strings.OfficeOM.L_CloseFileBeforeRetrieve = "_Čäĺľ çľóšëĄšýńč őń ţhë ćűŕŕéńť Fîľę bęfőřě řęťŕíěvíňg äńôţhęŕ.džšćđČdžšć_";
...
Strings.OfficeOM.L_FormattingReminder = "_Fôřmäţťîňg Ŕęmîńďéřdžš_";
...
Strings.OfficeOM.L_CellFormatAmountBeyondLimits = "_Ňôţę: Ťhę fóŕmáťťíňg śěţś śęţ bý ą Föřmâťţîňg API ćâľľ íş śüggéşťěđ ťô bě běłów 100.džšćđČdžšćđČd_";
Strings.OfficeOM.L_TooManyIncompleteRequests = "_Wâîť úńťîł ťhě pŕěvîöůş çăĺľ çômpľěťëş.džšćđČ_";
...
Strings.OfficeOM.L_APICallFailed = "_API Čäłĺ Fáîĺěďdž_";
...
Strings.OfficeOM.L_RequestTokenUnavailable = "_Ţhîś API häş běęń ťhŕôťţľęđ ţő şłöw ţhě čâłĺ fřéqµęńčý.džšćđČdžš_";
...
Strings.OfficeOM.L_BrowserAPINotSupported = "_Ťhîš bŕőwşęř ďôëš ňôť śµppóřť ťhé řéqúěšţëđ API.džšćđČdž_";
...
Strings.OfficeOM.L_APINotSupported = "_API Ńöť Šüppóřťëđdžš_";
Strings.OfficeOM.L_SliceSizeNotSupported = "_Ťhë şpęćífíéđ šľîçę şíżé íş ňőť šűppôŕťëđ.džšćđČd_";
...
Strings.OfficeOM.L_RequestTimeout = "_Ţhę ćáĺł ťôôk ťôô ľóňg ţö ęxęćűţé.džšćđ_";
...
Strings.OfficeOM.L_MemoryLimit = "_Męmöřý Łîmîť Ęxçęěďěđdžš_";
Strings.OfficeOM.L_CellDataAmountBeyondLimits = "_Ńőţě: Ťhę ńűmbëŕ öf čěĺłś îň ă ťąbľë îš šüggëśţěđ ţő bë béĺőw 20,000 čëľĺš.džšćđČdžšćđČ_";
...
Strings.OfficeOM.L_UserNotSignedIn = "_Ňö ůśęŕ îś šígńęď íňţó Óffíčé.džšćđ_";
...
Strings.OfficeOM.L_NetworkProblemRetrieveFile = "_A ńěťwóŕk pŕőbłëm häš přěvëńţëđ řéţřîěväľ őf ťhé fîĺě.džšćđČdžš_";
